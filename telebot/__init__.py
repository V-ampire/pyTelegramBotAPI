...
from telebot.apihelper_class import ApiHelper, ApiException
...
class TeleBot:
    ...
    def __init__(self, token, threaded=True, skip_pending=False, num_threads=2, proxy=None):
        """
        :param token: bot API token
        :return: Telebot object.
        """

        self.apihelper = ApiHelper(proxy=proxy)
    ...
    def set_webhook(self, url=None, certificate=None, max_connections=None, allowed_updates=None):
        return self.apihelper.set_webhook(self.token, url, certificate, max_connections, allowed_updates)
    ...
    def delete_webhook(self):
        ...
        :return: bool
        """
        return self.apihelper.delete_webhook(self.token)

    def get_webhook_info(self):
        result = self.apihelper.get_webhook_info(self.token)
    ...
    def get_updates(self, offset=None, limit=None, timeout=20, allowed_updates=None):
        ...
        """
        json_updates = self.apihelper.get_updates(self.token, offset, limit, timeout, allowed_updates)
        ret = []
    ...
    def get_me(self):
        result = self.apihelper.get_me(self.token)
        return types.User.de_json(result)

    def get_file(self, file_id):
        return types.File.de_json(self.apihelper.get_file(self.token, file_id))

    def get_file_url(self, file_id):
        return self.apihelper.get_file_url(self.token, file_id)

    def download_file(self, file_path):
        return self.apihelper.download_file(self.token, file_path)
    ...
    def get_user_profile_photos(self, user_id, offset=None, limit=None):
        ...
        :return: API reply.
        """
        result = self.apihelper.get_user_profile_photos(self.token, user_id, offset, limit)
    ...
    def get_chat(self, chat_id):
        ...
        :return:
        """
        result = self.apihelper.get_chat(self.token, chat_id)
    ...
    def leave_chat(self, chat_id):
        ...
        :return:
        """
        result = self.apihelper.leave_chat(self.token, chat_id)
        return result
    ...
    def get_chat_administrators(self, chat_id):
        ...
        :return:
        """
        result = self.apihelper.get_chat_administrators(self.token, chat_id)
        ret = []
        for r in result:
    ...
    def get_chat_members_count(self, chat_id):
        ...
        :return:
        """
        result = self.apihelper.get_chat_members_count(self.token, chat_id)
        return result
    ...
    def set_chat_sticker_set(self, chat_id, sticker_set_name):
        ...
        :return:
        """
        result = self.apihelper.set_chat_sticker_set(self.token, chat_id, sticker_set_name)
        return result
    ...
    def delete_chat_sticker_set(self, chat_id):
        ...
        :return:
        """
        result = self.apihelper.delete_chat_sticker_set(self.token, chat_id)
        return result
    ...
    def get_chat_member(self, chat_id, user_id):
        ...
        :return:
        """
        result = self.apihelper.get_chat_member(self.token, chat_id, user_id)
    ...
    def send_message(self, chat_id, text, disable_web_page_preview=None, reply_to_message_id=None, reply_markup=None,
        ...
        return types.Message.de_json(
            self.apihelper.send_message(self.token, chat_id, text, disable_web_page_preview, reply_to_message_id,
    ...
    def forward_message(self, chat_id, from_chat_id, message_id, disable_notification=None):
        ...
        """
        return types.Message.de_json(
            self.apihelper.forward_message(self.token, chat_id, from_chat_id, message_id, disable_notification))
    ...
    def delete_message(self, chat_id, message_id):
        ...
        :return: API reply.
        """
        return self.apihelper.delete_message(self.token, chat_id, message_id)
    ...
    def send_photo(self, chat_id, photo, caption=None, reply_to_message_id=None, reply_markup=None,
        ...
        """
        return types.Message.de_json(
            self.apihelper.send_photo(self.token, chat_id, photo, caption, reply_to_message_id, reply_markup,
    ...
    def send_audio(self, chat_id, audio, caption=None, duration=None, performer=None, title=None,
        ...
        """
        return types.Message.de_json(
            self.apihelper.send_audio(self.token, chat_id, audio, caption, duration, performer, title, reply_to_message_id,
    ...
    def send_voice(self, chat_id, voice, caption=None, duration=None, reply_to_message_id=None, reply_markup=None,
        ...
        """
        return types.Message.de_json(
            self.apihelper.send_voice(self.token, chat_id, voice, caption, duration, reply_to_message_id, reply_markup,
    ...
    def send_document(self, chat_id, data, reply_to_message_id=None, caption=None, reply_markup=None,
        ...
        """
        return types.Message.de_json(
            self.apihelper.send_data(self.token, chat_id, data, 'document', reply_to_message_id, reply_markup,
    ...
    def send_sticker(self, chat_id, data, reply_to_message_id=None, reply_markup=None, disable_notification=None,
        ...
        """
        return types.Message.de_json(
            self.apihelper.send_data(self.token, chat_id, data, 'sticker', reply_to_message_id, reply_markup,
    ...
    def send_video(self, chat_id, data, duration=None, caption=None, reply_to_message_id=None, reply_markup=None,
        ...
        """
        return types.Message.de_json(
            self.apihelper.send_video(self.token, chat_id, data, duration, caption, reply_to_message_id, reply_markup,
    ...
    def send_video_note(self, chat_id, data, duration=None, length=None, reply_to_message_id=None, reply_markup=None,
        ...
        """
        return types.Message.de_json(
            self.apihelper.send_video_note(self.token, chat_id, data, duration, length, reply_to_message_id, reply_markup,
                                      disable_notification, timeout))
    ...
    def send_media_group(self, chat_id, media, disable_notification=None, reply_to_message_id=None):
        ...
        :return:
        """
        result = self.apihelper.send_media_group(self.token, chat_id, media, disable_notification, reply_to_message_id)
        ret = []
        for msg in result:
    ...
    def send_location(self, chat_id, latitude, longitude, live_period=None, reply_to_message_id=None, reply_markup=None,
        ...
        """
        return types.Message.de_json(
            self.apihelper.send_location(self.token, chat_id, latitude, longitude, live_period, reply_to_message_id,
                                    reply_markup,
    ...
    def edit_message_live_location(self, latitude, longitude, chat_id=None, message_id=None,
        ...
        """
        return types.Message.de_json(
            self.apihelper.edit_message_live_location(self.token, latitude, longitude, chat_id, message_id,
    ...
    def stop_message_live_location(self, chat_id=None, message_id=None, inline_message_id=None, reply_markup=None):
        ...
        """
        return types.Message.de_json(
            self.apihelper.stop_message_live_location(self.token, chat_id, message_id, inline_message_id, reply_markup))
    ...
    def send_venue(self, chat_id, latitude, longitude, title, address, foursquare_id=None, disable_notification=None,
        ...
        """
        return types.Message.de_json(
            self.apihelper.send_venue(self.token, chat_id, latitude, longitude, title, address, foursquare_id,
    ...
    def send_contact(self, chat_id, phone_number, first_name, last_name=None, disable_notification=None,
                     reply_to_message_id=None, reply_markup=None):
        return types.Message.de_json(
            self.apihelper.send_contact(self.token, chat_id, phone_number, first_name, last_name, disable_notification,
    ...
    def send_chat_action(self, chat_id, action):
        ...
        """
        return self.apihelper.send_chat_action(self.token, chat_id, action)
    ...
    def kick_chat_member(self, chat_id, user_id, until_date=None):
        ...
        """
        return self.apihelper.kick_chat_member(self.token, chat_id, user_id, until_date)

    def unban_chat_member(self, chat_id, user_id):
        return self.apihelper.unban_chat_member(self.token, chat_id, user_id)
    ...
    def restrict_chat_member(self, chat_id, user_id, until_date=None, can_send_messages=None,
        ...
        :return: types.Message
        """
        return self.apihelper.restrict_chat_member(self.token, chat_id, user_id, until_date, can_send_messages,
    ...
    def promote_chat_member(self, chat_id, user_id, can_change_info=None, can_post_messages=None,
        ...
        :return:
        """
        return self.apihelper.promote_chat_member(self.token, chat_id, user_id, can_change_info, can_post_messages,
    ...
    def export_chat_invite_link(self, chat_id):
        ...
        :return:
        """
        return self.apihelper.export_chat_invite_link(self.token, chat_id)
    ...
    def set_chat_photo(self, chat_id, photo):
        ...
        :return:
        """
        return self.apihelper.set_chat_photo(self.token, chat_id, photo)
    ...
    def delete_chat_photo(self, chat_id):
        ...
        :return:
        """
        return self.apihelper.delete_chat_photo(self.token, chat_id)
    ...
    def set_chat_title(self, chat_id, title):
        ...
        :return:
        """
        return self.apihelper.set_chat_title(self.token, chat_id, title)
    ...
    def set_chat_description(self, chat_id, description):
        ...
        :return:
        """
        return self.apihelper.set_chat_description(self.token, chat_id, description)
    ...
    def pin_chat_message(self, chat_id, message_id, disable_notification=False):
        ...
        :return:
        """
        return self.apihelper.pin_chat_message(self.token, chat_id, message_id, disable_notification)
    ...
    def unpin_chat_message(self, chat_id):
        ...
        :return:
        """
        return self.apihelper.unpin_chat_message(self.token, chat_id)

    def edit_message_text(self, text, chat_id=None, message_id=None, inline_message_id=None, parse_mode=None,
                          disable_web_page_preview=None, reply_markup=None):
        result = self.apihelper.edit_message_text(self.token, text, chat_id, message_id, inline_message_id, parse_mode,
    ...
    def edit_message_media(self, media, chat_id=None, message_id=None, inline_message_id=None, reply_markup=None):
        result = self.apihelper.edit_message_media(self.token, media, chat_id, message_id, inline_message_id, reply_markup)
        if type(result) == bool:  # if edit inline message return is bool not Message.
            return result
        return types.Message.de_json(result)

    def edit_message_reply_markup(self, chat_id=None, message_id=None, inline_message_id=None, reply_markup=None):
        result = self.apihelper.edit_message_reply_markup(self.token, chat_id, message_id, inline_message_id, reply_markup)
        if type(result) == bool:
            return result
        return types.Message.de_json(result)
    ...
    def send_game(self, chat_id, game_short_name, disable_notification=None, reply_to_message_id=None,
                  reply_markup=None):
        result = self.apihelper.send_game(self.token, chat_id, game_short_name, disable_notification, reply_to_message_id,
                                     reply_markup)
        return types.Message.de_json(result)

    def set_game_score(self, user_id, score, force=None, chat_id=None, message_id=None, inline_message_id=None,
                       edit_message=None):
        result = self.apihelper.set_game_score(self.token, user_id, score, force, chat_id, message_id, inline_message_id,
                                          edit_message)
        if type(result) == bool:
            return result
        return types.Message.de_json(result)
    ...
    def get_game_high_scores(self, user_id, chat_id=None, message_id=None, inline_message_id=None):
        result = self.apihelper.get_game_high_scores(self.token, user_id, chat_id, message_id, inline_message_id)
        ret = []
        for r in result:
    ...
    def send_invoice(self, chat_id, title, description, invoice_payload, provider_token, currency, prices,
                     ...
                     provider_data=None):
        result = self.apihelper.send_invoice(self.token, chat_id, title, description, invoice_payload, provider_token,
    ...
    def send_poll(self, chat_id, poll, disable_notifications=False, reply_to_message=None, reply_markup=None):
        return types.Message.de_json(self.apihelper.send_poll(self.token, chat_id, poll.question, poll.options, disable_notifications, reply_to_message, reply_markup))

    def stop_poll(self, chat_id, message_id):
        return types.Poll.de_json(self.apihelper.stop_poll(self.token, chat_id, message_id))

    def answer_shipping_query(self, shipping_query_id, ok, shipping_options=None, error_message=None):
        return self.apihelper.answer_shipping_query(self.token, shipping_query_id, ok, shipping_options, error_message)

    def answer_pre_checkout_query(self, pre_checkout_query_id, ok, error_message=None):
        return self.apihelper.answer_pre_checkout_query(self.token, pre_checkout_query_id, ok, error_message)

    def edit_message_caption(self, caption, chat_id=None, message_id=None, inline_message_id=None,
                             parse_mode=None, reply_markup=None):
        result = self.apihelper.edit_message_caption(self.token, caption, chat_id, message_id, inline_message_id,
    ...
    def answer_inline_query(self, inline_query_id, results, cache_time=None, is_personal=None, next_offset=None,
        ...
        """
        return self.apihelper.answer_inline_query(self.token, inline_query_id, results, cache_time, is_personal, next_offset,
    ...
    def answer_callback_query(self, callback_query_id, text=None, show_alert=None, url=None, cache_time=None):
        ...
        :return:
        """
        return self.apihelper.answer_callback_query(self.token, callback_query_id, text, show_alert, url, cache_time)
    ...
    #     :return:
    #     """
    #     result = self.apihelper.send_sticker(self.token, chat_id, sticker, disable_notification, reply_markup, reply_markup)
    #     return types.Message.de_json(result)
    ...
    def get_sticker_set(self, name):
        ...
        :return:
        """
        result = self.apihelper.get_sticker_set(self.token, name)
    ...
    def upload_sticker_file(self, user_id, png_sticker):
        ...
        :return:
        """
        result = self.apihelper.upload_sticker_file(self.token, user_id, png_sticker)
    ...
    def create_new_sticker_set(self, user_id, name, title, png_sticker, emojis, contains_masks=None,
        ...
        :return:
        """
        return self.apihelper.create_new_sticker_set(self.token, user_id, name, title, png_sticker, emojis, contains_masks,
                                                mask_position)
    ...
    def add_sticker_to_set(self, user_id, name, png_sticker, emojis, mask_position=None):
        ...
        :return:
        """
        return self.apihelper.add_sticker_to_set(self.token, user_id, name, png_sticker, emojis, mask_position)
    ...
    def set_sticker_position_in_set(self, sticker, position):
        ...
        :return:
        """
        return self.apihelper.set_sticker_position_in_set(self.token, sticker, position)
    ...
    def delete_sticker_from_set(self, sticker):
        ...
        :return:
        """
        return self.apihelper.delete_sticker_from_set(self.token, sticker)
