...
class ApiHelper(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param proxy: Proxy for requests.
        :param API_URL: Base url for api methods.
        :param FILE_URL: Base url for file api methods.
        """

        self.proxy = kwargs.get('proxy', None)
        self.API_URL = kwargs.get('api_url', None)
        self.FILE_URL = kwargs.get('file_url', None)
        self.CONNECT_TIMEOUT = kwargs.get('connect_timeout', 3.5)
    ...
    def _check_result(self, method_name, result):
        """
    ...
    def get_file(self, token, file_id):
        ...
        return self._make_request(token, method_url, params={'file_id': file_id})


    def get_file_url(self, token, file_id):
        if self.FILE_URL is None:
            return "https://api.telegram.org/file/bot{0}/{1}".format(token, self.get_file(token, file_id).file_path)
        else:
            return self.FILE_URL.format(token, self.get_file(token, file_id)['file_path'])
    

    def download_file(self, token, file_path):
        url = self.FILE_URL.format(token, file_path)
        result = self._get_req_session().get(url, proxies=self.proxy)
        if result.status_code != 200:
            msg = 'The server returned HTTP {0} {1}. Response body:\n[{2}]' \
    ...
    def send_message(self, token, chat_id, text, disable_web_page_preview=None, reply_to_message_id=None, reply_markup=None,
        ...
        return self._make_request(token, method_url, params=payload, method='post')


    def set_webhook(self, token, url=None, certificate=None, max_connections=None, allowed_updates=None):
        ...
        return self._make_request(token, method_url, params=payload, files=files)
    ...
    def get_updates(self, token, offset=None, limit=None, timeout=None, allowed_updates=None):
    ...
    def get_user_profile_photos(self, token, user_id, offset=None, limit=None):
    ...
    def get_chat_administrators(self, token, chat_id):
        method_url = r'getChatAdministrators'
        payload = {'chat_id': chat_id}
        return self._make_request(token, method_url, params=payload)


    def get_chat_members_count(self, token, chat_id):
        method_url = r'getChatMembersCount'
        payload = {'chat_id': chat_id}
        return self._make_request(token, method_url, params=payload)


    def set_chat_sticker_set(self, token, chat_id, sticker_set_name):
        method_url = r'setChatStickerSet'
        payload = {'chat_id': chat_id, 'sticker_set_name': sticker_set_name}
        return self._make_request(token, method_url, params=payload)


    def delete_chat_sticker_set(self, token, chat_id):
        method_url = r'deleteChatStickerSet'
        payload = {'chat_id': chat_id}
        return self._make_request(token, method_url, params=payload)


    def get_chat_member(self, token, chat_id, user_id):
        method_url = r'getChatMember'
        payload = {'chat_id': chat_id, 'user_id': user_id}
        return self._make_request(token, method_url, params=payload)


    def forward_message(self, token, chat_id, from_chat_id, message_id, disable_notification=None):
    ...
    def send_photo(self, token, chat_id, photo, caption=None, reply_to_message_id=None, reply_markup=None,
                parse_mode=None, disable_notification=None):
        ...
        if disable_notification:
            payload['disable_notification'] = disable_notification
        return self._make_request(token, method_url, params=payload, files=files, method='post')


    def send_media_group(self, token, chat_id, media, disable_notification=None, reply_to_message_id=None):
        ...
        if reply_to_message_id:
            payload['reply_to_message_id'] = reply_to_message_id
        return self._make_request(token, method_url, params=payload, method='post' if files else 'get',
                            files=files if files else None)


    def send_location(self, token, chat_id, latitude, longitude, live_period=None, reply_to_message_id=None, reply_markup=None,
    ...
    def edit_message_live_location(self, token, latitude, longitude, chat_id=None, message_id=None,
    ...
    def stop_message_live_location(self, token, chat_id=None, message_id=None,
                                inline_message_id=None, reply_markup=None):
    ...
    def send_venue(self, token, chat_id, latitude, longitude, title, address, foursquare_id=None, disable_notification=None,
    ...
    def send_contact(self, token, chat_id, phone_number, first_name, last_name=None, disable_notification=None,
                    reply_to_message_id=None, reply_markup=None):
    ...
    def send_chat_action(self, token, chat_id, action):
        method_url = r'sendChatAction'
        payload = {'chat_id': chat_id, 'action': action}
        return self._make_request(token, method_url, params=payload)


    def send_video(self, token, chat_id, data, duration=None, caption=None, reply_to_message_id=None, reply_markup=None,
    ...
    def send_voice(self, token, chat_id, voice, caption=None, duration=None, reply_to_message_id=None, reply_markup=None,
    ...
    def send_video_note(self, token, chat_id, data, duration=None, length=None, reply_to_message_id=None, reply_markup=None,
    ...
    def send_audio(self, token, chat_id, audio, caption=None, duration=None, performer=None, title=None, reply_to_message_id=None,
    ...
    def send_data(self, token, chat_id, data, data_type, reply_to_message_id=None, reply_markup=None, parse_mode=None,
    ...
    def get_method_by_type(self, data_type):
    ...
    def kick_chat_member(self, token, chat_id, user_id, until_date=None):
    ...
    def unban_chat_member(self, token, chat_id, user_id):
        method_url = 'unbanChatMember'
        payload = {'chat_id': chat_id, 'user_id': user_id}
        return self._make_request(token, method_url, params=payload, method='post')


    def restrict_chat_member(self, token, chat_id, user_id, until_date=None, can_send_messages=None,
    ...
    def promote_chat_member(self, token, chat_id, user_id, can_change_info=None, can_post_messages=None,
    ...
    def export_chat_invite_link(self, token, chat_id):
        method_url = 'exportChatInviteLink'
        payload = {'chat_id': chat_id}
        return self._make_request(token, method_url, params=payload, method='post')


    def set_chat_photo(self, token, chat_id, photo):
    ...
    def edit_message_text(self, token, text, chat_id=None, message_id=None, inline_message_id=None, parse_mode=None,
    ...
    def edit_message_caption(self, token, caption, chat_id=None, message_id=None, inline_message_id=None,
    ...
    def edit_message_media(self, token, media, chat_id=None, message_id=None, inline_message_id=None, reply_markup=None):
        ...
        if reply_markup:
            payload['reply_markup'] = self._convert_markup(reply_markup)
        return self._make_request(token, method_url, params=payload, files=file, method='post' if file else 'get')


    def edit_message_reply_markup(self, token, chat_id=None, message_id=None, inline_message_id=None, reply_markup=None):
    ...
    def send_game(self, token, chat_id, game_short_name, disable_notification=None, reply_to_message_id=None, reply_markup=None):
    ...
    def set_game_score(self, token, user_id, score, force=None, disable_edit_message=None, chat_id=None, message_id=None,
    ...
    def get_game_high_scores(self, token, user_id, chat_id=None, message_id=None, inline_message_id=None):
        """
    ...
    def send_invoice(self, token, chat_id, title, description, invoice_payload, provider_token, currency, prices,
    ...
    def answer_shipping_query(self, token, shipping_query_id, ok, shipping_options=None, error_message=None):
        """
    ...
    def answer_pre_checkout_query(self, token, pre_checkout_query_id, ok, error_message=None):
        """
    ...
    def answer_callback_query(self, token, callback_query_id, text=None, show_alert=None, url=None, cache_time=None):
        """
    ...
    def answer_inline_query(self, token, inline_query_id, results, cache_time=None, is_personal=None, next_offset=None,
    ...
    def get_sticker_set(self, token, name):
        method_url = 'getStickerSet'
        return self._make_request(token, method_url, params={'name': name})


    def upload_sticker_file(self, token, user_id, png_sticker):
    ...
    def create_new_sticker_set(self, token, user_id, name, title, png_sticker, emojis, contains_masks=None, mask_position=None):
    ...
    def add_sticker_to_set(self, token, user_id, name, png_sticker, emojis, mask_position):
    ...
    def set_sticker_position_in_set(self, token, sticker, position):
        method_url = 'setStickerPositionInSet'
        payload = {'sticker': sticker, 'position': position}
        return self._make_request(token, method_url, params=payload, method='post')


    def delete_sticker_from_set(self, token, sticker):
        method_url = 'deleteStickerFromSet'
        payload = {'sticker': sticker}
        return self._make_request(token, method_url, params=payload, method='post')


    def send_poll(self, token, chat_id, question, options, disable_notifications=False, reply_to_message_id=None, reply_markup=None):
        method_url = r'sendPoll'
        payload = {'chat_id': str(chat_id), 'question': question, 'options': self._convert_list_json_serializable(options)}
    ...
    def stop_poll(self, token, chat_id, message_id, reply_markup=None):
    ...
    def _convert_list_json_serializable(self, results):
        ret = ''
        for r in results:
    ...
    def _convert_input_media(self, media):
        if isinstance(media, types.InputMedia):
            return media._convert_input_media()
        return None, None


    def _convert_input_media_array(self, array):
        media = []
        files = {}
